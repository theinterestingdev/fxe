...
import { register, verifyOTP } from "../api/api";
...
const SignUp = () => {
  ...
  // Updated version of startPathAnimation to keep track of the timeout ID
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 px-4 py-16">
      ...
      >
        ...
        <form className="space-y-5" onSubmit={otpSent ? handleSignUp : handleGetOtp}>
          {/* Email Field */}
          <motion.div
          ...
          {/* Password Fields - Only shown before OTP sent */}
          {!otpSent && (
            <>
              {/* Password Field */}
              <motion.div
